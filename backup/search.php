                ...
                <div class="col">
                    <form class="input-group rounded" method='POST' enctype='multipart/form-data'>
                        <div class="form-group  row g-3">
                            <input name="search"type="search" class="form-control col-md-4 rounded" placeholder="type in title..." aria-label="Search" aria-describedby="search-addon" />
                            
                            <input value ='Search'  class="btn btn-outline-dark btn-sm" type="submit" name='submit'/>
                        </div>
                    </form>
                </div>
            </div>
